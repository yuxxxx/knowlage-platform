# RailsAdmin config file. Generated on December 15, 2013 16:11
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Knowlage Platform', 'Admin']
  ...
  # config.excluded_models = ['Category', 'Comment', 'Question', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Comment', 'Question', 'User']
